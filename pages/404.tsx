...
const ErrorPage: NextPage = ({ categories, HeadProps }: InferGetStaticPropsType<typeof getStaticProps>) => {
    ...
    return (
        <Layout categories={categories}>
            ...
            <Row className={styles.errorRow}>
                <h1 className={`${styles.errorH1} mt-2 text-danger text-center `}>404<br /> Page not found</h1>
